...
remove_unwanted_packages() {
    ...
    local small8_packages=(
        "ppp" "firewall" "dae" "daed" "daed-next" "libnftnl" "nftables" "dnsmasq" "luci-theme-argon" "ddns-go" "luci-app-ddns-go" "luci-app-alist" "alist"
    )
...
install_small8() {
    ./scripts/feeds install -p small8 -f xray-core xray-plugin dns2tcp dns2socks haproxy hysteria \
        ...
        easytier luci-app-easytier msd_lite luci-app-msd_lite cups luci-app-cupsd luci-app-argon-config
}
